...
public class PowerDestroyBehaviour implements DestroyBehaviour {
	 ...
	 * 
	 * With this behavior, all 8 surrounding gems are destroyed.
	 * These gems can also recursively destroy more gems, which are all added 
	 * 	to the list of destroyed gems.
	 * 
	 * @param cells	Array of the cells containing all the gems
	 * @param pos	The position of the given gem on the board
	 * @return A list of the positions of all the other gems that got destroyed 
	 * 			when the given gem gets destroyed.
	 */
